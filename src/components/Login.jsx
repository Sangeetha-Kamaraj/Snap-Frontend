...
const Login = () => {
  ...
  const randomImage =
    "https://images.squarespace-cdn.com/content/v1/54a4656fe4b037e9babd6ec9/1525669925757-IR2EG4NQ7B7SCU776P1W/ke17ZwdGBToddI8pDm48kHH9S2ID7_bpupQnTdrPcoF7gQa3H78H3Y0txjaiv_0fDoOvxcdMmMKkDsyUqMSsMWxHk725yiiHCCLfrh8O1z4YTzHvnKhyp6Da-NYroOW3ZGjoBKy3azqku80C789l0nQwvinDXPV4EYh2MRzm-RRB5rUELEv7EY2n0AZOrEupxpSyqbqKSgmzcCPWV5WMiQ/Blog+images-17.jpg";
    ...
    <section className='min-h-screen flex items-stretch text-white '>
      ...
      >
        ...
        <div className='w-full py-6 z-20'>
          ...
          {incorrect ? (
            <div
              className='flex p-4 mb-4 text-sm text-red-800 text-center justify-center rounded-lg bg-red-40 dark:text-red-400'
              role='alert'
            >
              <svg
                aria-hidden='true'
              ...
              <div>
                <span className='font-medium'></span> Incorrect username or password
              </div>
            </div>
          ) : null}
